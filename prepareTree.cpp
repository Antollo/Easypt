...
std::pair<object::objectPtr, object::objectPtr> prepareTree()
{
    ...
    try
    {
        ...
        Root->addChild(makeObject(FunctionChooser<String0, wrongNumberOfArguments, String2>, name("String"))
            ...
            ->addChild(makeObject(VMethod<std::string, void (std::string::*)(char), &std::string::push_back, char>, name("pushBack")))
            ->addChild(makeObject(T2BOperator<std::string, std::greater, typeNames::String>, name(">")))
            ->addChild(makeObject(T2BOperator<std::string, std::less, typeNames::String>, name("<")))
            ->addChild(makeObject(T2BOperator<std::string, std::greater_equal, typeNames::String>, name(">=")))
            ->addChild(makeObject(T2BOperator<std::string, std::less_equal, typeNames::String>, name("<=")))
        ...
        Root->addChild(makeObject(StringIterator, name("StringIterator"))
            ...
            ->addChild(makeObject(TXTOperator<std::string::iterator, int, plus, typeNames::StringIterator, typeNames::Int>, name("+")))
            ->addChild(makeObject(TXTOperator<std::string::iterator, int, minus, typeNames::StringIterator, typeNames::Int>, name("-")))
        ...
        Root->addChild(makeObject(FunctionChooser<Array0, Array1, Array2>, name("Array"))
            ...
            ->addChild(makeObject(TFunction<std::vector<object::objectPtr> (*)(std::vector<object::objectPtr>::iterator, std::vector<object::objectPtr>::iterator), ArraySubarray, std::vector<object::objectPtr>, typeNames::Array, std::vector<object::objectPtr>::iterator, std::vector<object::objectPtr>::iterator>, name("subarray")))
        ...
        Root->addChild(makeObject(ArrayIterator, name("ArrayIterator"))
            ...
            ->addChild(makeObject(TXTOperator<std::vector<object::objectPtr>::iterator, int, plus, typeNames::ArrayIterator, typeNames::Int>, name("+")))
            ->addChild(makeObject(TXTOperator<std::vector<object::objectPtr>::iterator, int, minus, typeNames::ArrayIterator, typeNames::Int>, name("-")))
